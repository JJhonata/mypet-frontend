...
import { LayoutDashboard, Users, PawPrint, Calendar, TrendingUp, LogOut, X, UserCog, History, Scissors } from "lucide-react";
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="leading-tight min-w-0">
                <p className="text-xs text-slate-700 dark:text-slate-300">Admin</p>
